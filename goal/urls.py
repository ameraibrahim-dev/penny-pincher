...
urlpatterns = [
    ...
    # transactions
    path('transaction/create/', GoalListView.as_view(), name='create_transaction'),
    path('transaction/update/<int:pk>/', GoalListView.as_view(), name='update_transaction'),
    path('transaction/delete/<int:pk>', GoalListView.as_view(), name='delete_transaction'),
]
