...
urlpatterns = [
    ...
    path('custom/category/update', UpdateCustomCategoryView.as_view(), name='update_custom_categories_'),
    path('custom/category/delete', DeleteCustomCategoryView.as_view(), name='delete_custom_categories_list'),
